...
def register(name: str) -> Callable[[Callable[..., SolverAdapter]], Callable[..., SolverAdapter]]:
    def decorator(factory: Callable[..., SolverAdapter]) -> Callable[..., SolverAdapter]:
...
from tests.comparison.adapters import sip_mjx  # noqa: F401, E402
