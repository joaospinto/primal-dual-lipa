...
_PROBLEMS: dict[str, tuple[str, dict]] = {
    ...
    "h1_backflip": ("tests.comparison.problems.mjx_h1_backflip", {}),
    "h1_jump_forward": ("tests.comparison.problems.mjx_h1_jump_forward", {}),
    "aliengo_trot": ("tests.comparison.problems.mjx_aliengo_trot", {}),
}
